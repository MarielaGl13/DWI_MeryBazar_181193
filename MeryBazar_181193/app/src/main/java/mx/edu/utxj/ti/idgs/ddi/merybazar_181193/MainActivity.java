package mx.edu.utxj.ti.idgs.ddi.merybazar_181193;
...
public class MainActivity extends AppCompatActivity {
    ...
    private String url = "http://10.10.62.3:3300/";
                ...
                JsonObjectRequest peticion = new JsonObjectRequest(
                        ...
                        new Response.Listener<JSONObject>() {
                            ...
                            public void onResponse(JSONObject response) {
                                if (response.has("status"))
                                    Toast.makeText(MainActivity.this, "Prenda no encontrada", Toast.LENGTH_SHORT).show();
                                else {
                                    try {
                        ...
                        new Response.ErrorListener() {
                            ...
                            public void onErrorResponse(VolleyError error) {
                                Toast.makeText(MainActivity.this, "Prenda no encontrado", Toast.LENGTH_SHORT).show();
                            }
                        }
                );
                            ...
                            public void onResponse(JSONObject response) {
                                try {
                                    if (response.getString("status").equals("Producto insertado")) {
                                        Toast.makeText(MainActivity.this, "Prenda insertada con EXITO!", Toast.LENGTH_SHORT).show();
